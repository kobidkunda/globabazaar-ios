...
export const UPLOAD_ADDRESS_PROOF =
  BASE_URL + '/api/application/upload/birth_certificate';
export const UPLOAD_IDENTITY_PROOF =
  BASE_URL + '/api/application/upload/transfer_certificate';
